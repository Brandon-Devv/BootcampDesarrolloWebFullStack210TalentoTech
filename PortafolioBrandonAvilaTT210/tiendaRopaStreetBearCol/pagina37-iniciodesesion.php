...
<body> 
    ...
    <header>
      ...
      <div class="cuenta">
        <a href="php/pagina41.php"><p class="icon">
      ...
      <div class="contenedor-todo">
        ...
        <div class="caja-trasera">
          ...
          <div class="caja-trasera-login">
            ...
            <p>Inicia Sesión para entrar a la Página Web</p>
      ...
      <section class="bf">
        ...
        <div class="footer-redes">
          ...
          <div class="footer-nav">
            <a href="pagina36-terminosdelservicio.html"><p><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-badge-left" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
          ...
          <a href="pagina38-mantenimiento.html"><p><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-badge-right" width="52" height="52" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
